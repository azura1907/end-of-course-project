...
<head>
    ...
    <title>:: My-Task :: Skills List </title>
...
<body>
                                    ...
                                    <table id="skillTable" class="table table-hover align-middle mb-0" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <a href="{{route('admin.skill.edit',['id' => $skill->skill_id])}}">
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                            ...
                                                            data-bs-target="#removeskill-{{$skill->skill_id}}"><i class="icofont-close-circled text-danger"></i></button>
                                                        </div>
                                                </td>
                                            </tr> 
                                            @endforeach
    ...
    @foreach ($skills as $skill)
    <div class="modal fade" id="removeskill-{{$skill->skill_id}}" tabindex="-1"  aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title  fw-bold" id="dremovetaskLabel"> Remove Skill</h5>
            ...
            <div class="modal-body justify-content-center flex-column d-flex">
                ...
                <strong>"{{$skill->skill_name}}"</strong> from Skill List?</p>
            </div>
