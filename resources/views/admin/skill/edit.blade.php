...
<head>
    ...
    <title>:: My-Task:: Skill Edit</title>
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse show" id="extra-Components">
                            ...
                            <li><a class="ms-link active" href="{{route('admin.skill.index')}}"> <span>Skills</span></a></li>
        ...
        <div class="main px-lg-4 px-md-4 mt-4">
            ...
            <div class="card mb-3">
                <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                    <h6 class="mb-0 fw-bold ">Edit Skill</h6> 
                </div>
                <div class="card-body">
                    <form id="advanced-form" action="{{ route('admin.skill.update',['id' => $skill->skill_id]) }}" method="POST" data-parsley-validate novalidate>
                        @csrf
                        <div class="row g-3 align-items-center">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="skill_detail" name="skill_detail" 
                                    value="{{ old('skill_detail', $skill->skill_detail) }}"
                                    class="form-control">
                                    <label class="form-label mt-2"><strong>Status</strong></label>
                                    <br />
                                        <td>
                                            <input type="radio" name="status" value="1" {{ old('status', $skill->status) == 1 ? 'checked' : '' }}> Active
                                            <input type="radio" name="status" value="2" {{ old('status', $skill->status) == 2 ? 'checked' : '' }}> Block
                                        </td>
                                    <br />
                                </div>
                        </div>
