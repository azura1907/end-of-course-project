...
<head>
    ...
    <title>:: My-Task:: Project Category Edit</title>
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <br />
                                            <td>
                                                <input type="radio" name="status" value="1" {{ old('status', $project_category->status) == 1 ? 'checked' : '' }}> Active
                                                <input type="radio" name="status" value="2" {{ old('status', $project_category->status) == 2 ? 'checked' : '' }}> Block
                                            </td>
                                        <br />
                                    </div>
                            </div>
