                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                            <a href="{{route('admin.employee.edit',['id' => $employee->id])}}">
                                                                <button type="button" class="btn btn-dark btn-set-task w-sm-100"><i class="icofont-edit me-2 fs-6"></i></i>Edit</button>
                                                            </a>
                                                        </div>
                                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                            <a href="{{route('admin.employee.detailInfo',['id'=>$employee->id])}}">
                                                                <button type="button" class="btn btn-secondary btn-set-task w-sm-100"><i class="icofont-file-document me-2 fs-6"></i></i>Detail</button>
                                                            </a>
                                                        </div>
                                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                            <a href="{{route('admin.employee.updatePw',['id'=>$employee->id])}}">
                                                                <button type="button" class="btn btn-warning btn-set-task w-sm-100"><i class="icofont-exchange me-2 fs-6"></i></i>Reset PW</button>
                                                            </a>
                                                        </div>
                                                    </td>
                                                </tr>
