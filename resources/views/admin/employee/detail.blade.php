...
<head>
    ...
    <title>:: My-Task:: Employee Detail</title>
    <!-- project css file  -->
                            ...
                            <div class="row g-2 pt-2">
                                <div class="col-xl-5 mt-5">
                                    <a href="{{route('admin.employee.edit',['id' => $employee->id] )}}">
                                        <button type="button" class="btn btn-dark btn-set-task w-sm-100"><i class="icofont-edit fs-6"></i>Edit Employee</button>
                                    </a>
                                </div>
                                <div>
                                    <a href="{{route('admin.employee.infoEdit',['id' => $employee->id] )}}">
                                        <button type="button" class="btn btn-warning btn-set-task w-sm-100"><i class="icofont-edit fs-6"></i>Edit Employee Personal Info</button>
                                    </a>
                                </div>
                            </div>
                        </div>
