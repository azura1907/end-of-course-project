...
<head>
    ...
    <title>:: My-Task:: Department Edit</title>
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br />
                                        <td>
                                            <input type="radio" name="status" value="1" {{ old('status', $department->status) == 1 ? 'checked' : '' }}> Active
                                            <input type="radio" name="status" value="2" {{ old('status', $department->status) == 2 ? 'checked' : '' }}> Block
                                        </td>
                                    <br />
                                </div>
                        </div>
